...
const Contact = () => {
  ...
  // Ouvre le client mail avec les données du formulaire
    ...
    <section className="py-10 md:py-14">
      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_260px]">
        ...
        >
          ...
          <button
            type="submit"
            className="flex w-fit items-center gap-2 rounded-full border border-[rgba(120,243,210,0.3)] bg-[rgba(120,243,210,0.08)] px-5 py-2.5 text-sm font-semibold text-[#78f3d2] transition-colors duration-200 hover:bg-[rgba(120,243,210,0.15)]"
          >
            <Send size={14} />
            Envoyer
          </button>
