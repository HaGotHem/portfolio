...
export const PROJETS = [
  ...
  },
  {
    ...
    desc: "Application web CRM reliant la billetterie Weezevent d'un club de volley-ball à ses listes de diffusion Brevo. Architecture en couches avec Slim 4, repositories pour l'accès à PostgreSQL, templates Twig et déploiement conteneurisé Docker, avec un tableau de bord des places vendues et de la recette. Responsable du dépôt : j'ai réalisé le front-end de bout en bout, la page Statistiques (agrégats SQL et affichage) et l'export sélectif vers Brevo.",
    tech: [
      "PHP 8.2",
      "Slim 4",
      "PostgreSQL 16",
